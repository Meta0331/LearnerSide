        ...
        <ThemedView style={styles.container}>
            ...
            <View style={styles.body}>
                <View style={styles.layer1}>
                    ...
                    <TouchableOpacity style={styles.ChangeProfileBtn} onPress={() => router.push('/profile')}>
            ...
            <View style={styles.footer}>
                <View style={styles.categoryContainer}>
                    <TouchableOpacity style={styles.categoryInfosActive} onPress={() => router.push('/profile')}>
                        <Image source={require('@/assets/images/user2.png')} style={styles.CategoryImage} />
                        <Text style={styles.categoryText} numberOfLines={2} adjustsFontSizeToFit>Account Information</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.categoryInfos} onPress={() => router.push('/changepass')}>
                        <Image source={require('@/assets/images/lock.png')} style={styles.CategoryImage} />
                        <Text style={styles.categoryText} numberOfLines={2} adjustsFontSizeToFit>Change Password</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ThemedView>
